clear;
a=load('C:\Users\admin\Desktop\组会\2024.4.29\fg_ng_mcn\4-8\fg_1_spat.mat');
...
for i = 1:10
    for j = 1:5
        a1{1,i}{1,j} = mean(a.spat1{1,i}{1,j});
        b1{1,i}{1,j} = mean(b.spat1{1,i}{1,j});
    end
end
